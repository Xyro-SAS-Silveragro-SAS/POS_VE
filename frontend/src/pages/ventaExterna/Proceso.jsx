                ...
                <div className="w-full lg:w-[50%] m-auto">
                    <div className="p-4">
                                    ...
                                    <>
                                        <div className="flex justify-between items-center py-2 border-b border-gray-700">
                                            ...
                                            <span className="font-normal uppercase">
                                                {cabezaPedido.dt_fecha_reg ? new Date(cabezaPedido.dt_fecha_reg).toISOString().split('T')[0] : 'N/A'}
                                            </span>
                                        </div>
                                        <div className="flex justify-between items-center py-2 border-b border-gray-700">
                        ...
                        {cabezaPedido && cabezaPedido.sync === 1 && cabezaPedido.in_tipo ==='cotizaciones' && (
                            <>
                                <a href={`${API_MTS}api/cotizacion/pdf/${cabezaPedido.id_consec}`} download={`cotizacion_${cabezaPedido.id_consec}.pdf`} className="m-auto bg-red-700 p-4 lg:w-[50%] font-bold rounded-lg flex items-center  cursor-pointer justify-between">
                                    BAJAR PDF
