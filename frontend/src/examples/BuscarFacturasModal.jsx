...
const API_FACTURAS = import.meta.env.VITE_API_FACTURAS || 'https://n8n.srv1097949.hstgr.cloud/webhook/getFacturas';
    ...
    const buscarFacturas = async () => {
      ...
      try {
        const res = await fetch(API_FACTURAS, {
          ...
          body: JSON.stringify({ codigoSN: cliente.id, emailUsuario: usuario?.tx_usuario }),
        });
