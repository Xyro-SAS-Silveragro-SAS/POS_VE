...
const CardProducto = ({index=null, item=null, handleAddToCar=null, buttonAdd=true, buttonDel=false, initializeProcess=null,modificaDb=false}) => {
            ...
            {showImageModal && (
                <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4" onClick={closeImageModal}>
                    <div className="relative max-w-4xl max-h-full">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-75 text-white p-4 rounded-b-lg opacity-80">
